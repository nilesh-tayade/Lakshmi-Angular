...
export const contentroutes: Routes = [
  {path:'',redirectTo:'applicant',pathMatch:'full'},
    ...
    {path:'caller-lead',loadChildren:() => import('src/app/technical-caller-lead/technical-caller-lead.module').then(m => m.TechnicalCallerLeadModule),canActivate:[IsLoggedInGuard]},
